...
export const AUDIT = [
  { type: 'assign', actor: 'Thabo Nkosi', entity: 'CA 123 GP', channel: 'Web', date: '18 Jun 2026', time: '09:14',
    ...
    meta: 'Acme Mining Corp · Vehicle assignment' },
  { type: 'user', actor: 'Kobus van der Merwe', entity: 'Lindiwe Mokoena', channel: 'Web', date: '18 Jun 2026', time: '08:55',
    ...
    meta: 'Acme Mining Corp · User created' },
  { type: 'insp', actor: 'Johan Swart', entity: '#2120352', channel: 'Mobile app', date: '18 Jun 2026', time: '06:15',
    ...
    meta: 'Acme Mining Corp · Pre-use inspection' },
  { type: 'unassign', actor: 'Thabo Nkosi', entity: 'WC 321 CT', channel: 'Web', date: '17 Jun 2026', time: '16:40',
    text: '**Thabo Nkosi** unassigned **WC 321 CT** from operator Bennie Pietersen — reason: scheduled maintenance',
    meta: 'Acme Mining Corp · Vehicle assignment' },
  { type: 'warn', actor: 'System', entity: 'WC 321 CT', channel: 'Automatic', date: '17 Jun 2026', time: '21:31',
    ...
    meta: 'Acme Mining Corp · Automatic action' },
  { type: 'assign', actor: 'Thabo Nkosi', entity: 'JHB 456 GP', channel: 'Web', date: '17 Jun 2026', time: '14:22',
    text: '**Thabo Nkosi** assigned **JHB 456 GP** to operator **Lindiwe Mokoena** under supervisor Priya Dlamini',
    meta: 'Acme Mining Corp · Vehicle assignment' },
  { type: 'user', actor: 'Kobus van der Merwe', entity: 'Priya Dlamini', channel: 'Web', date: '16 Jun 2026', time: '11:20',
    text: '**Kobus van der Merwe** assigned supervisor **Priya Dlamini** under safety officer **Thabo Nkosi**',
    meta: 'Acme Mining Corp · Hierarchy change' },
  { type: 'insp', actor: 'Bennie Pietersen', entity: '#2120347', channel: 'Mobile app', date: '17 Jun 2026', time: '05:51',
    text: '**Bennie Pietersen** submitted inspection **#2120347** for DBN 001 NP — Go-but (W×2)',
    meta: 'Grootegeluk Coal · Pre-use inspection' },
  { type: 'warn', actor: 'System', entity: 'Mandla Dube', channel: 'Automatic', date: '16 Jun 2026', time: '02:00',
    text: '**System** flagged **Mandla Dube** — red permit area awareness has no valid record',
    meta: 'Zimele Logistics · Competency check' },
];
